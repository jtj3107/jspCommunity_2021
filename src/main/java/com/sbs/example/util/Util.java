...
import com.sbs.example.util.MailAuth.MailAuth;
...
public class Util {
	...
	public static int send(String smtpServerId, String smtpServerPw, String from, String fromName, String to, String title,
			String body) {
